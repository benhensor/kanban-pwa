...
function DeleteModal({ setIsDeleteModalOpen, type, title, onDeleteBtnClick}: DeleteModalProps) {
  return (
    <div
      onClick={(e) => {
    ...
    >
      ...
      <div
        className=" scrollbar-hide overflow-y-scroll max-h-[95vh]  my-auto  bg-white dark:bg-darkGrey text-black dark:text-white font-bold shadow-md shadow-[#364e7e1a] max-w-md mx-auto  w-full px-8  py-8 rounded-xl "
      >
        <h3
          className="font-bold text-red text-xl "
        >
          Delete this {type}?
        </h3>
        {type === 'task' ? (
